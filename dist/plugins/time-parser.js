 ...
 */
export class TimeParserPlugin {
    constructor() {
        this.name = "time-parser";
        this.description = "Parses natural language time references into specific date ranges";
        this.version = "1.0.0";
        this.config = {};
    }
    async initialize(server, config) {
        ...
        server.tool("parse_time_reference", {
    ...
    parseTimeReference(reference, refDate = new Date(), timezone = "UTC") {
    ...
    getTimezoneOffset(timezone, date) {
        try {
            ...
            const targetDate = Date.UTC(timeParts.year, timeParts.month - 1, // JavaScript months are 0-indexed
            timeParts.day, timeParts.hour, timeParts.minute, timeParts.second);
