/**
 * Utility functions for Limitless MCP server
 */
import { Lifelog, Topic } from '../types';
 ...
 */
export function getTimeRangeText(lifelogs: Lifelog[]): string {
 ...
 */
export function extractSnippet(text: string, query: string, contextLength: number = 100): string {
 ...
 */
export function generateSummary(lifelog: Lifelog, level: string, focus: string): string {
 ...
 */
export function generateCombinedSummary(lifelogs: Lifelog[], level: string): string {
